...
![Paleta de cores](cap-images/ranking_palette_genres_prices.png "Title: cores e percentuais"){fig-alt="Imagem com paleta de cores e suas porcentagens" width="30%"}
...
Outro ponto que acho importante citar, que podemos notar pelo histograma e pelos quartis, é que **aproximadamente dos terços** da nossa base p**ossui entre 120-1000 avaliações**, com apenas alguns poucos jogos que tem mais avaliações, e por conseguinte mais populares.
